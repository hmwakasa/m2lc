...
\begin{frame}
	\frametitle{結果 \(S=1366\hmu{W/m^2}\) 30 年目}
	\begin{columns}
		\begin{column}{.4\textwidth}
			\includegraphics[height=\textwidth,angle=-90]{S1366U,time=10950-crop.pdf}
			\includegraphics[height=\textwidth,angle=-90]{S1366SurfTemp,time=10950-crop.pdf}
		\end{column}
		\begin{column}{.4\textwidth}
...
\begin{frame}
	\frametitle{結果 \(S=1500\hmu{W/m^2}\) 3 年目}
	\begin{columns}
		\begin{column}{.4\textwidth}
			\includegraphics[height=\textwidth,angle=-90]{S1500U,time=1095-crop.pdf}
			\includegraphics[height=\textwidth,angle=-90]{S1500SurfTemp,time=1095-crop.pdf}
		\end{column}
		\begin{column}{.4\textwidth}
...
\begin{frame}
	\frametitle{結果 \(S=1600\hmu{W/m^2}\) 10 年目}
	\begin{columns}
		\begin{column}{.4\textwidth}
			\includegraphics[height=\textwidth,angle=-90]{S1600U,time=3650-crop.pdf}
			\includegraphics[height=\textwidth,angle=-90]{S1600SurfTemp,time=3650-crop.pdf}
		\end{column}
		\begin{column}{.4\textwidth}
...
\begin{frame}
	\frametitle{結果 \(S=1800\hmu{W/m^2}\) 10 年目}
	\begin{columns}
		\begin{column}{.4\textwidth}
			\includegraphics[height=\textwidth,angle=-90]{S1800U,time=3650-crop.pdf}
			\includegraphics[height=\textwidth,angle=-90]{S1800SurfTemp,time=3650-crop.pdf}
		\end{column}
		\begin{column}{.4\textwidth}
